<template>
    <div class="flex items-center justify-center h-screen">
        <div
            ...
            <form @submit.prevent="update" class="m-20">
                <div class="grid md:grid-cols-2 md:gap-6">
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        ...
                        <ErrorMessage v-if="form.errors.cep">
                            {{ form.errors.cep }}
                        </ErrorMessage>
                    </div>
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        ...
                        <ErrorMessage v-if="form.errors.endereco">
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        ...
                        <ErrorMessage v-if="form.errors.numero">
                            {{ form.errors.numero }}
                        </ErrorMessage>
                    </div>
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        ...
                        <ErrorMessage v-if="form.errors.complemento">
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        ...
                        <ErrorMessage v-if="form.errors.bairro">
                            {{ form.errors.bairro }}
                        </ErrorMessage>
                    </div>
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        ...
                        <ErrorMessage v-if="form.errors.estado">
                            {{ form.errors.estado }}
                        </ErrorMessage>
                    </div>
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        ...
                        <ErrorMessage v-if="form.errors.cidade">
                            {{ form.errors.cidade }}
                        </ErrorMessage>
                    </div>
                </div>
...
const form = useForm({
    ...
    endereco: props.address.endereco,
...
const update = () => form.put(`/patients/${props.patient.id}`);
</script>
